...
extensions = [
    Extension(
        'za_traffic_detection.keras_retinanet.keras_retinanet.utils.compute_overlap',
        ['za_traffic_detection/keras_retinanet/keras_retinanet/utils/compute_overlap.pyx']
    ),
]
